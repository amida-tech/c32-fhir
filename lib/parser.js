...
var ManufacturedMaterial = function (resource) {
    ...
    case 'Immunization':
        this._self = {
            ...
            code: function (node) {
                ensureProperty.call(resource, 'code');
                ensureProperty.call(resource.code, 'coding', true).push(makeCode(node));
            },
    ...
    this.templateId = function (node) {
        ...
        case '1.3.6.1.4.1.19376.1.5.3.1.4.14': //IHE Encounter Entry
            ...
            this._self = {
                ...
                code: function (node) {
                    ensureProperty.call(encounter, 'type');
                    ensureProperty.call(encounter.type, 'coding', true).push(makeCode(node));
...
var ClinicalDocument = function (patientId, parserStream) {
    ...
    this.component = function (node) {
        ...
        var c32TemplateId = ['2.16.840.1.113883.3.88.11.32.1' /* Patient Summary */ ,
        ...
        if (_.any(templateId, function (value) {
                return _.contains(c32TemplateId, value);
            })) {
...
module.exports = C32ParserStream;
